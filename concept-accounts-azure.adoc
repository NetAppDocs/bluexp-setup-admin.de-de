...
image:screenshot_accounts_switch_azure.gif["Ein Screenshot, der die Auswahl zwischen Cloud-Provider-Konten zeigt, nachdem Sie auf der Seite Details  Anmeldedaten auf Konto wechseln geklickt haben."]
