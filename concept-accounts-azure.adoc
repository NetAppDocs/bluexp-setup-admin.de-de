...
summary: Sie sollten wissen, wie BlueXP Azure Zugangsdaten und Berechtigungen verwendet, sodass Sie Anmeldedaten für eine oder mehrere Azure Abonnements managen können. 
---
...
[role="lead"]
Sie sollten wissen, wie BlueXP Azure Zugangsdaten und Berechtigungen verwendet, sodass Sie Anmeldedaten für eine oder mehrere Azure Abonnements managen können.
