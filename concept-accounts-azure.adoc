...
summary: BlueXP nutzt Azure Zugangsdaten und -Berechtigungen, um die Zugangsdaten für ein oder mehrere Azure Abonnements zu managen. So könnten Sie beispielsweise mehr über das Hinzufügen weiterer Azure Zugangsdaten zu BlueXP erfahren. 
---
...
[role="lead"]
BlueXP nutzt Azure Zugangsdaten und -Berechtigungen, um die Zugangsdaten für ein oder mehrere Azure Abonnements zu managen. So könnten Sie beispielsweise mehr über das Hinzufügen weiterer Azure Zugangsdaten zu BlueXP erfahren.
