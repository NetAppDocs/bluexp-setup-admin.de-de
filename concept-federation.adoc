...
* Laden Sie die herunter, und füllen Sie die aus https://["Antragsformular für die NetApp Föderation"^]
...
Wenn Ihr Identitätsanbieter nicht in der Liste oben angezeigt wird, https://["Befolgen Sie diese allgemeinen Anweisungen"^]
...
| 2 | BlueXP Admin  a| 
Wechseln Sie zum https://["NetApp Federation Setup-Seite"^] Stellen Sie die Verbindung zu BlueXP her.
...
| 4 | BlueXP Admin | Testen und aktivieren Sie die Verbindung vom https://["NetApp Federation Setup-Seite"^]Beachten Sie, dass die Seite zwischen dem Testen der Verbindung und dem Aktivieren der Verbindung aktualisiert wird. 
|===
...
https://["Anweisungen zur Registrierung der Applikation bei Azure AD anzeigen"^]
...
https://["Anweisungen zur Konfiguration des ADFS-Servers mit auth0 anzeigen"^]
...
https://["Anweisungen zum Erstellen einer Verbindung anzeigen"^]
...
Nachdem der BlueXP Admin eine Verbindung ermöglicht hat, kann der Admin die Verbindung jederzeit über das aktualisieren https://["NetApp Federation Setup-Seite"^]
