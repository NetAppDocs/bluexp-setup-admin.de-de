...
summary: Identity Federation ermöglicht Single Sign-On mit BlueXP, sodass Benutzer sich mithilfe von Anmeldedaten Ihrer Unternehmensidentität anmelden können. Sie sollten darüber informieren, wie BlueXP Identitätsföderation unterstützt, bevor Sie eine Verbindung mit Ihrem Identitätsanbieter herstellen. 
---
...
[role="lead"]
Identity Federation ermöglicht Single Sign-On mit BlueXP, sodass Benutzer sich mithilfe von Anmeldedaten Ihrer Unternehmensidentität anmelden können. Sie sollten darüber informieren, wie BlueXP Identitätsföderation unterstützt, bevor Sie eine Verbindung mit Ihrem Identitätsanbieter herstellen.
...
== Aktualisieren Sie eine verbundene Verbindung
