...
summary: Sie sollten verstehen, wie BlueXP AWS-Anmeldedaten und -Berechtigungen verwendet, damit Sie Anmeldedaten für ein oder mehrere AWS-Konten managen können. So könnten Sie beispielsweise mehr über das Hinzufügen weiterer AWS Zugangsdaten zu BlueXP erfahren. 
---
...
[role="lead"]
Sie sollten verstehen, wie BlueXP AWS-Anmeldedaten und -Berechtigungen verwendet, damit Sie Anmeldedaten für ein oder mehrere AWS-Konten managen können. So könnten Sie beispielsweise mehr über das Hinzufügen weiterer AWS Zugangsdaten zu BlueXP erfahren.
