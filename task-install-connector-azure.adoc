...
summary: Erstellen Sie den Connector direkt über die webbasierte Konsole von BlueXP, über den Azure Marketplace oder durch Installation der Software auf Ihrem eigenen Linux-Host. 
---
= Erstellen Sie den Connector in Azure
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Erstellen Sie den Connector direkt über die webbasierte Konsole von BlueXP, über den Azure Marketplace oder durch Installation der Software auf Ihrem eigenen Linux-Host.
