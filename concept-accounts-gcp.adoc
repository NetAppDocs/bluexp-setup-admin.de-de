...
summary: BlueXP nutzt Google Cloud-Anmeldedaten und -Berechtigungen, um Anmeldedaten für ein oder mehrere Google Cloud-Projekte zu managen. Vielleicht möchten Sie mehr über das Servicekonto erfahren, das mit der Connector-VM verbunden ist. 
---
...
[role="lead"]
BlueXP nutzt Google Cloud-Anmeldedaten und -Berechtigungen, um Anmeldedaten für ein oder mehrere Google Cloud-Projekte zu managen. Vielleicht möchten Sie mehr über das Servicekonto erfahren, das mit der Connector-VM verbunden ist.
...
. Bei der Bereitstellung des Connectors werden Sie aufgefordert, ein auszuwählen https://cloud.google.com/iam/docs/service-accounts["Servicekonto"^] Für die VM-Instanz. BlueXP erhält Berechtigungen über das Servicekonto, um Cloud Volumes ONTAP Systeme für Sie zu erstellen und zu managen – u. v. m. Berechtigungen werden durch Hinzufügen einer benutzerdefinierten Rolle an das Servicekonto bereitgestellt.
