...
summary: Sie sollten wissen, was Sie für den Einstieg in BlueXP im eingeschränkten Modus benötigen, um Ihre Umgebung vorzubereiten. 
---
...
[role="lead"]
Sie sollten wissen, was Sie für den Einstieg in BlueXP im eingeschränkten Modus benötigen, um Ihre Umgebung vorzubereiten.
