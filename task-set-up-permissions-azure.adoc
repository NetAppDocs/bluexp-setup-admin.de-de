...
+
.. Wählen Sie die Rolle *Azure SetupAsService* aus und wählen Sie *Next* aus.
+
...
.. Wählen Sie *Mitglieder auswählen*, wählen Sie Ihr Benutzerkonto aus und wählen Sie *Select* aus.
.. Wählen Sie *Weiter*.
