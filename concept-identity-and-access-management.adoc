...
Ordner können Projekte, andere Ordner oder beides enthalten.
...
Wenn Sie eine Ressource einem Ordner zuordnen, ist sie nicht automatisch für alle Projekte zugänglich. Nur der Ordner- oder Projektadministrator kann die Ressource sehen. Der Ordner- oder Projektadministrator entscheidet, welche Projekte darauf zugreifen können, und ordnet die Ressource den entsprechenden Projekten zu.
