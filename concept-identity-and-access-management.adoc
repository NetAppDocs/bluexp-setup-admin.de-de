...
[role="lead"]
BlueXP  Identitäts- und Zugriffsmanagement (IAM) ist ein grundlegender und skalierbarer Mechanismus zur Zugriffssteuerung, der den Benutzerzugriff auf BlueXP -Ressourcen verwaltet und entsprechende Berechtigungsstufen über Rollen mit den geringsten Berechtigungen gewährt.

Mit IAM können Sie den Zugriff auf Ihre NetApp-Ressourcen organisieren und steuern. Sie können Ihre Ressourcen nach der Hierarchie Ihrer Organisation organisieren. Sie können beispielsweise Ressourcen nach geographischem Standort, Standort oder Geschäftseinheit organisieren. Anschließend können Sie den Mitgliedern in bestimmten Teilen der Hierarchie IAM-Rollen zuweisen, wodurch der Zugriff auf Ressourcen in anderen Teilen der Hierarchie verhindert wird.
...
Benutzer müssen über die Administratorrolle „Organisation“ oder die Rolle „Ordner“ oder „Projektadministrator“ verfügen, um Ordner verwalten zu können. Benutzer mit Administratorrolle des Unternehmens können Ressourcen überall in Ihrer BlueXP -Organisation erstellen und verwalten. Benutzer mit der Rolle „Ordner“ und „Projektadministrator“ können dies nur für die Ordner oder Projekte tun, denen sie zugewiesen wurden.

Link::Reference-iam-predefined-roles.HTML[Erfahren Sie mehr über BlueXP -Rollen.]

Bei der Verwendung von BlueXP  IAM verwalten Benutzer mit diesen Rollen die folgenden Komponenten:
...
Eine _Organisation_ ist die oberste Ebene des IAM-Systems von BlueXP  und repräsentiert in der Regel Ihr Unternehmen. Ihr Unternehmen besteht aus Ressourcen wie Connectors, Speicher und Abonnements, die Sie in Ordnern und Projekten organisieren können. Sie können dann Organisationsmitglieder (Benutzer) Zugriff auf Ordner oder Projekte entsprechend ihrer Verantwortung bei der Verwaltung Ihrer Speicherumgebungen zuweisen.
...
Abhängig von der Größe Ihres Unternehmens und der Anzahl der vorhandenen Speicherressourcen sind Ordner ein nützliches Werkzeug, um Ihre NetApp-Ressourcen organisiert zu halten. Sie ermöglichen Ihnen auch eine bessere Zugriffsverwaltung, wenn Sie die Verwaltung verschiedener Ordner für verschiedene Benutzer freigeben möchten. Sie können einem Benutzer die Rolle „Ordner“ oder „Projektadministrator“ für einen bestimmten Ordner zuweisen und dann den Zugriff auf den Ordner und seine Projekte verwalten sowie neue Projekte im Ordner erstellen.

Wenn Sie einen Ordner erstellen, können Sie ihm Benutzerzugriff zuweisen. Wenn Sie einem Benutzer eine Zugriffsrolle zuweisen, kann dieser Benutzer die mit dieser Rolle verbundenen Aufgaben für alle Projekte innerhalb des jeweiligen Ordners ausführen. Umgekehrt können Sie den Benutzerzugriff auf ein Projekt pro Projekt gewähren.
...
Sie erstellen mehrere Projekte, um einen granulareren Zugriff auf Ihre NetApp-Ressourcen zu ermöglichen. Kleinere Unternehmen haben beispielsweise für jede Geschäftseinheit oder jeden geografischen Standort ein Projekt. Größere Unternehmen möchten ihre Storage-Ressourcen möglicherweise pro Geschäftseinheit in mehrere Projekte einteilen, um den Zugriff weiter zu kontrollieren. Sie können Benutzern Zugriff auf Ressourcen nach Projekt oder Ordner zuweisen.
...
Wenn sich Ihre Projekte in einem Ordner befinden, können Sie dies tun
