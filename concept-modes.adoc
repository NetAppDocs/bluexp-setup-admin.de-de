...
+
--
Eine sichere Region umfasst https://["AWS C2S UND SC2S"^] Und https://["Azure IL6"^]
...
Erste Schritte mit dem Standardmodus:: Wechseln Sie zum https://["BlueXP webbasierte Konsole"^] Und melden Sie sich an.
+
--
...
| Backup und Recovery | Unterstützt in kommerziellen Regionen AWS und Azure. Nicht in Google Cloud oder in unterstützt https://["AWS C2S/SC2S"^] Oder https://["Azure IL6"^] 
...
| Backup und Recovery | Es wird nur Backup und Restore von lokalen ONTAP Volumes in StorageGRID Systemen unterstützt.https://["Erfahren Sie, wie Sie On-Premises-ONTAP-Daten in StorageGRID sichern"^] 


| Klassifizierung  a| 
* Die einzigen unterstützten Datenquellen sind die, die Sie lokal ermitteln können.
+
https://["Zeigen Sie die Quellen an, die Sie lokal ermitteln können"^]

* Funktionen, für die ein abgehender Internetzugang erforderlich ist, werden nicht unterstützt.
+
https://["Zeigen Sie die Funktionseinschränkungen an"^]
...
https://["Erweitern Sie Ihr Digital Wallet von BlueXP um Lizenzen"^]
