...
Jeder Bereitstellungsmodus unterscheidet sich hinsichtlich der Anforderungen an die ausgehende Konnektivität, des Bereitstellungsorts, des Installationsprozesses, der Authentifizierungsmethode, der verfügbaren Daten- und Speicherdienste und der Abrechnungsmethoden.

Standardmodus:: Sie nutzen einen SaaS-Dienst über die webbasierte Konsole. Abhängig von den Datendiensten und Funktionen, die Sie nutzen möchten, erstellt ein BlueXP-Administrator einen oder mehrere Connectors zur Datenverwaltung in Ihrer Hybrid-Cloud-Umgebung.
+
--
Dieser Modus verwendet verschlüsselte Datenübertragung über das öffentliche Internet.

--
Eingeschränkter Modus:: Sie installieren einen BlueXP Connector in der Cloud (in einer Regierungsregion, einer souveränen Cloud-Region oder einer kommerziellen Region) und verfügen über eine eingeschränkte ausgehende Konnektivität zur BlueXP SaaS-Schicht. Benutzer greifen lokal über die webbasierte Konsole auf BlueXP zu, die über den Connector verfügbar ist und nicht über die SaaS-Schicht.
+
--
