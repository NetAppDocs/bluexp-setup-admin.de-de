...
.16+| *Services* | Meldungen | Nein | Nein 


| Backup und Recovery | Jahttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-limited-internet-connectivityView[] die Liste der unterstützten Backup-Ziele für ONTAP Volume-Daten^] | Jahttps://docs.netapp.com/us-en/bluexp-backup-recovery/prev-ontap-protect-journey.html#support-for-sites-with-no-internet-connectivity["Zeigen Sie die Liste der unterstützten Backup-Ziele für ONTAP-Volume-Daten an"^] 
...
.6+| *Eigenschaften* | Identitäts- und Zugriffsmanagement | Ja. 
