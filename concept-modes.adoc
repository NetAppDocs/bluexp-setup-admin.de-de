...
* Backup und Restore von lokalen ONTAP Volumes auf StorageGRID Systemen wird unterstützt.
+
...
* Backup und Restore von lokalen ONTAP-Volumes in ONTAP S3 wird ebenfalls unterstützt.
+
https://docs.netapp.com/us-en/bluexp-backup-recovery/task-backup-onprem-to-ontap-s3.html["Erfahren Sie, wie Sie On-Premises-ONTAP-Daten in ONTAP S3 sichern"^]
