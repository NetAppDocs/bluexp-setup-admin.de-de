...
| Cloud-Backup | Unterstützt in Regierungsregionen und Geschäftsregionen mit eingeschränkter Betriebsart. Nicht unterstützt in souveränen Regionen mit eingeschränktem Modus. Die folgenden Funktionen werden nicht unterstützt: Applikationen, Virtual Machines und Kubernetes. 


| Cloud-Daten Sinnvoll  a| 
...
| Digital Wallet | Sie können die Digital Wallet mit den unten aufgeführten unterstützten Lizenzierungsoptionen für den eingeschränkten Modus verwenden. 
...
| Cloud-Backup | Unterstützt in kommerziellen Regionen AWS und Azure. Nicht in Google Cloud oder in unterstützt https://aws.amazon.com/federal/us-intelligence-community/["AWS C2S/SC2S"^] Oder https://learn.microsoft.com/en-us/azure/compliance/offerings/offering-dod-il6["Azure IL6"^] 
...
| Digital Wallet | Sie können die Digital Wallet mit den unten aufgeführten unterstützten Lizenzierungsoptionen für den privaten Modus verwenden. 
...
| Cloud-Backup | Es wird nur Backup und Restore von lokalen ONTAP Volumes in StorageGRID Systemen unterstützt.https://docs.netapp.com/us-en/cloud-manager-backup-restore/task-backup-onprem-private-cloud.html["Erfahren Sie, wie Sie On-Premises-ONTAP-Daten in StorageGRID sichern"^] 
...
+
--
Bei Cloud Volumes ONTAP BYOL wird nur Node-basierte Lizenzierung unterstützt. Kapazitätsbasierte Lizenzierung wird nicht unterstützt. Da keine ausgehende Internetverbindung verfügbar ist, müssen Sie Ihre Cloud Volumes ONTAP-Lizenzdatei manuell in das Digital Wallet hochladen.

https://docs.netapp.com/us-en/cloud-manager-cloud-volumes-ontap/task-manage-node-licenses.html#add-unassigned-licenses["Hier erfahren Sie, wie Sie dem Digital Wallet Lizenzen hinzufügen"^]
...
[cols="33h,33,33"]
|===
| BlueXP Service oder Feature | Eingeschränkter Modus | Privater Modus 


| Amazon FSX für ONTAP | Ja. | Nein 


| Amazon S3 | Nein | Nein 


| AppTemplate | Nein | Nein 
...
| Cloud-Daten Sinnvoll | Ja. | Ja. 


| Cloud-Synchronisierung | Nein | Nein 


| Cloud Tiering | Nein | Nein 
...
| Digital Advisor | Nein | Nein 


| Digital Wallet | Ja. | Ja. 
...
| Globaler Datei-Cache | Nein | Nein 
...
| Schutz Vor Ransomware | Nein | Nein 
