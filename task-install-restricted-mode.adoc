...
** https://["Azure Marketplace-Seite für Azure Government Regions"^]
...
+
Diese Einstellung ist wichtig, da sich die Virtual Machine Connector mit Azure Active Directory identifizieren kann, ohne dass Anmeldedaten vorhanden sind. https://["Erfahren Sie mehr über Managed Identitäten für Azure Ressourcen"^].
...
.Schritte
. Wechseln Sie zum https://["BlueXP-Konsole"^] Und melden Sie sich an.
. Klicken Sie oben rechts in der BlueXP-Konsole auf das Symbol Einstellungen und wählen Sie *Anmeldeinformationen*.
+
image:screenshot_settings_icon.gif["Ein Screenshot, in dem das Symbol Einstellungen oben rechts in der BlueXP-Konsole angezeigt wird."]
