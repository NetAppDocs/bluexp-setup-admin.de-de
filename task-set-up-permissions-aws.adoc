...
summary: Richten Sie AWS Berechtigungen ein, damit Sie BlueXP für das Management Ihrer Daten- und Storage-Infrastruktur in AWS verwenden können. Wie Sie Berechtigungen einrichten, hängt von der Installationsoption ab, die Sie verwenden möchten. 
---
...
[role="lead"]
Richten Sie AWS Berechtigungen ein, damit Sie BlueXP für das Management Ihrer Daten- und Storage-Infrastruktur in AWS verwenden können. Wie Sie Berechtigungen einrichten, hängt von der Installationsoption ab, die Sie verwenden möchten.
...
TIP: Wenn BlueXP den Connector erstellt, wendet es einen neuen Satz an Berechtigungen auf die Connector-Instanz an, die den Connector zu AWS Ressourcen ermöglicht.
