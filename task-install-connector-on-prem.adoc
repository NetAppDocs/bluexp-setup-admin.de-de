...
summary: Installieren Sie einen Connector vor Ort, melden Sie sich an und richten Sie ihn für die Arbeit mit Ihrem BlueXP -Konto ein. 
---
...
+
Beachten Sie, dass Docker Engine 26 mit _New_ Connector-Installationen ab Version 3.9.44 des Connectors unterstützt wird.
