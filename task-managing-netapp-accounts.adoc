...
[role="lead"]
Sie können Ihr Konto verwalten, indem Sie Benutzer, Servicekonten, Arbeitsbereiche und Connectors verwalten.

link:concept-netapp-accounts.html["Erfahren Sie mehr über die Funktionsweise von BlueXP Accounts"].
