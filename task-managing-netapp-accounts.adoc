...
* Cloud-Backup
+
Cloud Backup wird in Regierungsregionen unterstützt, wenn die SaaS-Plattform deaktiviert ist, nicht aber in kommerziellen Regionen, in denen die SaaS-Plattform deaktiviert ist
