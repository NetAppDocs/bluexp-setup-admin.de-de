...
summary: Sie können die Google Cloud-Anmeldedaten verwalten, die der VM-Instanz Connector zugeordnet sind. 
---
...
[role="lead"]
Sie können die Google Cloud-Anmeldedaten verwalten, die der VM-Instanz Connector zugeordnet sind.
