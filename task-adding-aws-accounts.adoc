...
Weitere Informationen finden Sie im https://docs.netapp.com/us-en/cloud-manager-fsx-ontap/requirements/task-setting-up-permissions-fsx.html["BlueXP Dokumentation für Amazon FSX for ONTAP"^]
