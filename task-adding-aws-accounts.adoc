...
+
Wenn Sie BlueXP neue AWS Zugangsdaten hinzufügen, erhalten Sie unter BlueXP die erforderlichen Berechtigungen zum Erstellen und Managen von FSX für ONTAP. https://["Erfahren Sie, wie Sie Berechtigungen für FSX für ONTAP einrichten"^]
...
+
*** https://["Zeigen Sie die für FSX für ONTAP erforderlichen Berechtigungen an"^]
...
Weitere Informationen finden Sie im https://["BlueXP Dokumentation für Amazon FSX for ONTAP"^]
