...
+
https://["Hier finden Sie die vollständige Liste der unterstützten Regionen"^]

* Diese Version des Connectors enthält Cloud Volumes ONTAP-Verbesserungen.
+
https://["Erfahren Sie mehr über Verbesserungen bei Cloud Volumes ONTAP"^]
...
https://["Erfahren Sie mehr über diese Bereitstellungsmodi"].
...
+
https://["Hier erfahren Sie, wie Sie E-Mail-Benachrichtigungen einrichten"].
...
+
https://["Erfahren Sie, wie Sie die Anmeldedaten von Benutzern verwalten"].
...
+
https://["Erfahren Sie, wie Sie Support-Fälle erstellen und managen"].
...
+
** https://["Erfahren Sie mehr über Verbesserungen bei Cloud Volumes ONTAP"^]
** https://["Die ONTAP-On-Premises-Cluster-Verbesserungen"^]
...
+
https://["Erfahren Sie, wie Sie Ihre Support-Fälle managen"].
...
** https://["Legen Sie los – mit Cloud Volumes ONTAP"^]


* Mit dem Connector können Sie jetzt Amazon S3 Buckets aus BlueXP hinzufügen und managen.
+
https://["So fügen Sie über BlueXP neue Amazon S3 Buckets in Ihrem AWS-Konto hinzu"^].
...
+
** https://["Verbinden Sie ein AWS Abonnement"]
** https://["Lesen Sie, wie Sie ein Azure-Abonnement zuordnen"]
** https://["So verknüpfen Sie ein Google Cloud-Abonnement"]


* BlueXP benachrichtigt Sie nun, wenn Ihr Connector 14 Tage oder länger ausgeschaltet wurde.
+
** https://["Erfahren Sie mehr über BlueXP-Benachrichtigungen"]
** https://["Erfahren Sie, warum die Anschlüsse weiterhin ausgeführt werden sollten"]
...
+
https://["Zeigen Sie Google Cloud-Berechtigungen für den Connector an"].
...
* Die URL für die BlueXP-Konsole wurde auf aktualisiert https://[]
...
+
https://["Hier erfahren Sie, wie Sie Ihre Abonnements verwalten"^]
...
Cloud Manager fordert Sie jetzt auf, die mit Ihren Accounts der NetApp Support Website verbundenen Anmeldeinformationen zu aktualisieren, wenn das mit Ihrem Konto verknüpfte Aktualisierungs-Token nach 3 Monaten abläuft. https://["Erfahren Sie, wie Sie NSS-Konten verwalten"^]
...
+
https://["Erfahren Sie, wie Sie einen Fall erstellen"].
...
+
https://["Entdecken Sie FSX für ONTAP mithilfe von My Opportunities"^]
...
https://["Das Beispiel zeigt die AWS IAM-Rollenberechtigungen, die zum Erstellen eines Konnektors verwendet werden"].

Außerdem haben wir eine Seite erstellt, die Links zu den einzelnen Richtlinien enthält. https://["Zeigen Sie die Berechtigungsübersicht für Cloud Manager an"].
...
+
https://["Weitere Informationen zu Überwachungsvorgängen in Ihrem Konto"].
...
* Wir haben den Connector in Google Cloud auf einer VM-Instanz mit einem Betriebssystem zertifiziert, das unterstützt https://["Geschirmte VM-Funktionen"^]
* Diese Version des Connectors enthält auch Cloud Volumes ONTAP-Verbesserungen. https://["Erfahren Sie mehr über diese Verbesserungen"^]
...
+
https://["Erfahren Sie, wie Sie einen Konnektor mithilfe einer IAM-Rolle erstellen"].
...
Diese Version des Connectors enthält Cloud Volumes ONTAP-Verbesserungen. https://["Erfahren Sie mehr über diese Verbesserungen"^]
...
https://["Zeigen Sie die Liste der erforderlichen Endpunkte an"]
...
* https://["Erfahren Sie mehr über die Verwendung von Microsoft Azure AD durch NetApp zum Identitätsmanagement"^]
...
https://["SOC 2-Berichte von NetApp anzeigen"^].
...
https://["Erfahren Sie mehr über die Überprüfung von AutoSupport mit Cloud Volumes ONTAP"^]
