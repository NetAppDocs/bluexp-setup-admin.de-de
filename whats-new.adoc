...
* https://docs.netapp.com/us-en/cloud-volumes-ontap-relnotes["Erfahren Sie mehr über die Unterstützung von Cloud Volumes ONTAP für Skalierungssets von Virtual Machines"^]
