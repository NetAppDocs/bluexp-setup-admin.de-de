...
| Stecker | 3.9.50, 3.9.49 | GTO auf https://docs.netapp.com/us-en/bluexp-setup-admin/whats-new.html#connector-3-9-50["Was ist neu in BlueXP  Connector Seite"] und beziehen sich auf die Änderungen, die für die Versionen 3.9.50 und 3.9.49 enthalten sind. 
