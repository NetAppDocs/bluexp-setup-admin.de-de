...
summary: 'Informieren Sie sich über die Neuerungen bei den BlueXP Administrationsfunktionen: NetApp Accounts, Connectors, Zugangsdaten für Cloud-Provider und vieles mehr.' 
---
= Was ist neu
:hardbreaks:
:allow-uri-read: 
...
[role="lead"]
Informieren Sie sich über die Neuerungen bei den BlueXP Administrationsfunktionen: NetApp Accounts, Connectors, Zugangsdaten für Cloud-Provider und vieles mehr.
...
+
link:task-manage-user-credentials.html["Erfahren Sie, wie Sie Benutzerkennungen festlegen"].
