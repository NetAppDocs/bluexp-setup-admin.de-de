...
==== Unterstützung für Docker Engine 26

Docker Engine ist das erforderliche Container-Orchestrierungstool bei der Installation des Connectors auf Ubuntu 22.04 LTS.

Ab der Version 3.9.44 des Connectors wird Docker Engine 26 jetzt mit _New_ Connector-Installationen unterstützt.

Die aktualisierte Liste der unterstützten Docker Engine-Versionen lautet wie folgt:

* Die unterstützte Version ist mindestens 23.0.6.
* Die maximal unterstützte Version ist 26.0.0.
