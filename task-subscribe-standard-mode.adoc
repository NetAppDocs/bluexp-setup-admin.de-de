...
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-aws-accounts.html["Managen Sie AWS Anmeldeinformationen und Abonnements für BlueXP"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-azure-accounts.html["Managen Sie Azure Anmeldedaten und Abonnements für BlueXP"]
* https://docs.netapp.com/us-en/cloud-manager-setup-admin/task-adding-gcp-accounts.html["Managen Sie Google Cloud-Anmeldedaten und -Abonnements für BlueXP"]
