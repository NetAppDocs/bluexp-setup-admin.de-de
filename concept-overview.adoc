...
+
--
* Einrichtung und Verwendung https://["Cloud Volumes ONTAP"^] Für effizientes, Cloud-übergreifendes Multi-Protokoll-Datenmanagement
* Cloud-File-Storage-Services einrichten und verwenden:
+
** https://["Azure NetApp Dateien"^]
** https://["Amazon FSX für ONTAP"^]
** https://["Cloud Volumes Service für Google Cloud"^]


* Erkennung und Management https://["On-Premises-Storage"^]:
+
** E-Series Systeme
** ONTAP Cluster
** StorageGRID Systeme
...
* Orchestrieren und sichern https://["Persistente Kubernetes-Daten"^]
...
+
--
* https://["Kopieren und Synchronisieren"^]
* https://["Edge-Caching"^]
* https://["Tiering"^]
...
+
--
* https://["Klassifizierung"^]
* https://["Digitaler Berater"^]
* https://["Schutz durch Ransomware"^]


--


https://["Erfahren Sie mehr darüber, wie Sie BlueXP für Ihr Unternehmen einsetzen können"^]
...
Die Preise für BlueXP hängen von den Leistungen ab, die Sie verwenden möchten. https://["Weitere Informationen zu den Preisen für BlueXP"^]
...
Auf BlueXP kann über eine zugegriffen werden https://["Webbasierte Konsole"^] Und APIs. Dank SaaS-Erfahrung können Sie automatisch auf die neuesten Funktionen zugreifen, sobald sie veröffentlicht wurden, und ganz einfach zwischen Ihren BlueXP Konten und Connectors wechseln.
