...
---
= Connector-Host-Anforderungen für AWS-Installationen prüfen
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
Wenn Sie den Connector von BlueXP oder aus dem AWS Marketplace implementieren, enthält das Image die erforderlichen Betriebssystem- und Softwarekomponenten.
