...
[NOTE]
====
* Derzeit werden Benachrichtigungen zu den folgenden BlueXP Funktionen und Services per E-Mail gesendet: Connectors, Cloud Sync, Cloud-Backup, Digital Wallet und Ransomware-Schutz. Weitere Services werden in zukünftigen Versionen hinzugefügt.
