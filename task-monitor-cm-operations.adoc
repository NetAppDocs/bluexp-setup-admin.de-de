...
[NOTE]
====
* Für die folgenden Funktionen und Dienste werden Benachrichtigungen per E-Mail gesendet: Connector, digitale Geldbörse, Kopieren und Synchronisieren sowie Sichern und Wiederherstellen.
