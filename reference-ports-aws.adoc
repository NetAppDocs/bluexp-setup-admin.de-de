...
| TCP | 9060, 9061 | Ermöglicht die Aktivierung und Nutzung von Cloud Data Sense und Cloud Backup in öffentlicher Cloud-Implementierungen. Diese Ports sind auch für Cloud Backup erforderlich, wenn Sie die SaaS-Schnittstelle in Ihrem BlueXP-Konto deaktivieren. 
|===
...
.3+| API-Aufrufe | TCP | 3000 | ONTAP HA Mediator | Kommunikation mit dem ONTAP HA Mediator 
