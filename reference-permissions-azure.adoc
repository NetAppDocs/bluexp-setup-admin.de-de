...
* link:task-set-up-permissions-azure.html["Berechtigungen für Connector-Installation in Azure einrichten (Standardmodus)"]
...
* https://review.docs.netapp.com/us-en/cloud-manager-setup-admin_feb-2022-modes/task-prepare-private-mode.html#prepare-cloud-permissions["Richten Sie Berechtigungen für den privaten Modus ein"]
...
.8+| Managen Sie einen Load Balancer für HA-Paare | Microsoft.Network/loadBalancers/read | Ja. | Ja. | Nein 
...
Die Berechtigung „Microsoft.Storage/storageAccounts/delete“ wird für Cloud Data Sense nicht mehr benötigt.
