...
* Microsoft.Storage/StorageAccounts/blobServices/Container/write
+
Diese Berechtigung ist für das Backup und Recovery von BlueXP sowie für BlueXP Tiering erforderlich.

* Microsoft.Network/publicIPAddresses/delete
+
Diese Berechtigung ist für das Backup und Recovery von BlueXP erforderlich.
