...
\https://login.microsoftonline.com | Für das Managen von Ressourcen in Azure Public Regionen. 


| \https://management.chinacloudapi.cn
\https://login.chinacloudapi.cn | Für das Management von Ressourcen in Azure China Regionen. 
