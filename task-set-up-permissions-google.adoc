...
[role="lead"]
Richten Sie Google Cloud-Berechtigungen ein, damit Sie BlueXP für das Management Ihrer Daten- und Storage-Infrastruktur in Google Cloud verwenden können.
