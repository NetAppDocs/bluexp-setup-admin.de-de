...
summary: Erstellen Sie den Connector direkt über die webbasierte BlueXP Konsole, über gcloude oder durch Installation der Software auf Ihrem eigenen Linux Host. 
---
= Erstellen Sie den Connector in Google Cloud
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
...
[role="lead"]
Erstellen Sie den Connector direkt über die webbasierte BlueXP Konsole, über gcloude oder durch Installation der Software auf Ihrem eigenen Linux Host.
