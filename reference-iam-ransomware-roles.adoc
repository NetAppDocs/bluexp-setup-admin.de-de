...
[role="lead"]
Ransomware-Rollen wurden für den Zugriff auf den Ransomware-Datensicherungsservice entwickelt. Benutzern kann entweder eine Administratorrolle zugewiesen werden, mit der sie Maßnahmen zum Schutz vor Ransomware ergreifen können, oder eine Zuschauerrolle, wenn sie nur Überwachungsaufgaben übernehmen. Die beiden Rollen sind Ransomware Protection Admin und Ransomware Protection Viewer. Der Hauptunterschied zwischen den beiden Rollen sind die Aktionen, die sie zum Schutz vor Ransomware ergreifen können.
